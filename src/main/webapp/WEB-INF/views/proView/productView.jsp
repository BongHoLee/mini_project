...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
	 ...
	 <c:if test="${resultMap.page == 'category' }">
	 <p style="font-size: 21px; font-weight: bold; margin: 15px; border-bottom: 1px solid darkgray;">Category</p>
	 </c:if>
	<c:if test="${resultMap.page == 'brand' }">
	 <p style="font-size: 21px; font-weight: bold; margin: 15px; border-bottom: 1px solid darkgray;">brand</p>
	 </c:if>
