...
<table class="table table-bordered">
    ...
    <tbody>
        <form action=" <c:url value='/noticeView/noticemodify'/>" method="post" encType="multiplart/form-data">
            <tr>
                <th>제목: </th>
            ...
            <tr>
                <th>작성자 </th>
                <td><input type="text" placeholder="${resultData.ID}" name="AUTHOR" class="form-control" disabled/></td>
            </tr>
            <tr>
                <td colspan="2">
